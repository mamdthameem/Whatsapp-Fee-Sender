/**
 * PDF upload and WhatsApp send controller (waPdf)
 */
...
exports.sendPdfViaWhatsApp = async (req, res) => {
  ...
  try {
    ...
    try {
      ...
      logger.info(`PDF stored successfully. path=fee-receipts/${storedFileName} bucket=${config.STORAGE.FIREBASE_STORAGE_BUCKET}`);
    } catch (error) {
